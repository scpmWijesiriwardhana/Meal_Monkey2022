                    ...
                    <li class="nav-item ml-0">
                        ...
                        if (empty($_SESSION["user_id"])) // if user is not login
                        {
                            echo '<li class="nav-item"><a href="login.php" class="nav-link active">Login</a> </li>
							  <li class="nav-item ml-0"><a href="registration.php" class="nav-link active">Register</a> </li>';
                        } else {


                            echo  '<li class="nav-item ml-0"><a href="orders.php" class="nav-link active">My Orders</a> </li>';
                            echo  '<li class="nav-item ml-0"><a href="logout.php" class="nav-link active">Logout</a> </li>';
                        }
        ...
        <div class="profile">
            <div class="container">
                <div class="row" style="margin-top: 30px;">
                    <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img" style="margin-top: 30px;">
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rs.
                                    2.99</span></div>
